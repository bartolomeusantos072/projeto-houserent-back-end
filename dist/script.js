            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.user.create({
                        data: {
                            ...
                            phone: faker_1.faker.phone.number('+55 32 #### ####'),
                            cellphone: faker_1.faker.phone.number('+55 32 #### #####'),
                            ...
                            address: {
                                create: {
                                    ...
                                    number: faker_1.faker.random.numeric(),
                                    complement: faker_1.faker.company.name(),
                                    zipCode: faker_1.faker.address.zipCode(),
                                    referencePoint: faker_1.faker.company.catchPhraseAdjective()
                                }
                            }
                        }
                    })];
