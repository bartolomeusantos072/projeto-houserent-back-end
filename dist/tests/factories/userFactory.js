...
function signUp() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prisma.user.create({
                        data: {
                            name: faker_1.faker.internet.email(),
                            password: bcrypt_1["default"].hashSync(faker_1.faker.internet.password(), 12),
                            email: faker_1.faker.internet.email(),
                            phone: faker_1.faker.phone.number('32########'),
                            cellphone: faker_1.faker.phone.number('32#########'),
                            cpf: faker_1.faker.phone.number('###########'),
                            address: {
                                create: {
